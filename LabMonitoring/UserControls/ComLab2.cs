...
{
    public partial class ComLab2 : UserControl
    {
        ...
        private void ComLab2_Load(object sender, EventArgs e)
        {
            LoadData();
        }
        ...
        public void LoadData()
        {
            try
            {
                ...
                string sql = "SELECT reports.reportid AS ReportID, reports.usernumber as UserID, " +
                    ...
                    "INNER JOIN comlab ON reports.labid = comlab.labid) WHERE reports.labid = 2 " +
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (cbSearch.Text == "Item")
                {
                    ...
                    "reports.labid = 2 ORDER BY reportid DESC;";
                }
                else if (cbSearch.Text == "Time In")
                {
                    ...
                    "INNER JOIN users ON reports.usernumber = users.usernumber) " +
                    "INNER JOIN comlab ON reports.labid = comlab.labid) WHERE " +
                    "reports.timein LIKE '%" + txtSearch.Text + "%' AND reports.labid = 2" +
                    " ORDER BY reportid DESC";
                }
                else if (cbSearch.Text == "Time Out")
                {
                    ...
                    "INNER JOIN users ON reports.usernumber = users.usernumber) " +
                    "INNER JOIN comlab ON reports.labid = comlab.labid) WHERE " +
                    "reports.timeout LIKE '%" + txtSearch.Text + "%' AND reports.labid = 2 " +
                    "ORDER BY reportid DESC";
                }
                else if (cbSearch.Text == "First Name")
                {
                    ...
                    "OR LOWER(users.firstname) LIKE '%" + searchValue + "%' AND reports.labid = 2 " +
                    "ORDER BY reportid DESC";
                }
                else if (cbSearch.Text == "Last Name")
                {
                    ...
                    "OR LOWER(users.lastname) LIKE '%" + searchValue + "%' AND reports.labid = 2 " +
                    "ORDER BY reportid DESC";
                }
                else if (cbSearch.Text == "Date Created")
                {
                    ...
                    "AND reports.labid = 2 ORDER BY reportid DESC";
                }
                else if (cbSearch.Text == "Section")
                {
                    ...
                    "OR LOWER(reports.section) LIKE '%" + searchValue + "%' AND reports.labid = 2 " +
                    "ORDER BY reportid DESC";
                }
                else if (cbSearch.Text == "Quantity")
                {
                    ...
                    "OR LOWER(reports.qty) LIKE '%" + searchValue + "%' AND reports.labid = 2 " +
                    "ORDER BY reportid DESC";
                }
                else if (cbSearch.Text == "Remarks")
                {
                    ...
                    "OR LOWER(reports.remarks) LIKE '%" + searchValue + "%' AND reports.labid = 2 " +
                    "ORDER BY reportid DESC";
                }
